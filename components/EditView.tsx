...
import { EditOptions, Theme, AspectRatio, LogoPosition, LogoData } from '../types';
...
const EditView: React.FC<EditViewProps> = ({ imageSrc, onEnhance }) => {
  ...
  }, [onEnhance, theme, message, ctaText, logoData, aspectRatio, logoPosition]);
        ...
        <ControlGroup title="Customize Text & Brand">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
                <input type="text" value={message} onChange={e => setMessage(e.target.value)} placeholder="Primary message..." className="w-full bg-gray-700 text-white text-sm p-2.5 rounded-md border border-gray-600 focus:border-blue-500 focus:ring-blue-500" />
